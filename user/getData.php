...
if (isset($_POST['page'])) {
    ...
    AND perusahaan.kota LIKE '%" . $_POST['lokasi'] . "%' AND loker.jenis LIKE '%" . $_POST['jenis'] . "%' AND loker.id_perusahaan=perusahaan.id_perusahaan ORDER BY loker.tgl_tutup DESC LIMIT $offset,$limit");
    if ($query->num_rows > 0) {
?>
