  ...
  <div class="wrapper">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            if ($ad = mysqli_fetch_array($admin)) {
            ?>
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <span class="hidden-xs"><?= $ad['nama_admin'] ?></span>
                </a>
    ...
    <aside class="main-sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="index.php?page=perusahaan"><i class="fa fa-book"></i> <span>Perusahaan</span></a></li>
        <li><a href="index.php?page=peserta"><i class="fa fa-book"></i> <span>User</span></a></li>
      </ul>
      </section>
    </aside>
