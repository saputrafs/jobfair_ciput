<div class="box-header">
  <h3 class="box-title">Daftar Pelamar Diterima</h3>
</div>
<!-- /.box-header -->
<div class="box-body">
  ...
  <table id="example1" class="table table-bordered table-striped">
    ...
    <tbody>
      <?php
      $no = 0;
      $pelamar = mysqli_query($koneksi, "SELECT * FROM loker,lamaran,user,perusahaan WHERE perusahaan.id_perusahaan=loker.id_perusahaan AND lamaran.id_loker=loker.id_loker AND lamaran.id_user=user.id_user AND loker.id_perusahaan='$id' AND lamaran.hasil='terima' ORDER BY id_lamaran DESC");
